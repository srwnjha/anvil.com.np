            ...
            <section className="ot-blog-wrapper blog-details space-top space-extra-bottom">
                <div className="container">
                    <div className="text-center py-5">
                        ...
                        <Link to="/blog" className="ot-btn mt-4">Back to Blog</Link>
                    </div>
                </div>
            </section>
        );
                        ...
                        <div className="col-xxl-8 col-lg-7">
                            <div className="ot-blog blog-single">
                                ...
                                {post.postType === 'gallery' && (
                                    <div className="blog-img">
                                        <div ref={swiperRef} className="ot-react-slider" data-slider-options='{"effect":"fade"}'>
                                            ...
                                            <button className="slider-arrow slider-prev"><i className="far fa-angle-left" /></button>
                                            <button className="slider-arrow slider-next"><i className="far fa-angle-right" /></button>
                                        </div>
                                    </div>
                                )}
                                <div className="blog-content">
                                    ...
                                    {post.content.quote && (
                                        <blockquote>
                                            ...
                                            <span className="desig">{post.content.quote.designation}</span>
                                        </blockquote>
                                    )}
                                    <p className="mb-40">
                                        {post.content.middleContent}
                                    </p>
