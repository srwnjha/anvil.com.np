  ...
  useEffect(() => {
    ...
    const setupMenu = () => {
      ...
      allLis.forEach((li) => {
        ...
        if (submenu) {
          ...
          const link = Array.from(li.children).find(
            (child) =>
    ...
    const closeSiblingMenus = (currentLi) => {
      ...
      const siblings = Array.from(parentUl.children).filter(
        (child) =>
          child !== currentLi &&
          child.classList.contains("ot-item-has-children")
      );
    ...
    const handleMenuClick = (e) => {
      ...
      if (
        clickedLink &&
        clickedLink.parentElement.classList.contains("ot-item-has-children")
      ) {
    ...
    <div className="ot-menu-wrapper" ref={menuWrapperRef}>
      <div className="ot-menu-area text-center">
        ...
        <div className="mobile-logo">
          <Link to="/">
            <img
              src={process.env.PUBLIC_URL + "/assets/img/anvil/anvilfooter.png"}
              alt="Tronix"
              style={{
                width: "170px",
                height: "auto",
